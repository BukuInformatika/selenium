...
Masukkan code berikut untuk test mengisi form email dan tanggal lahir pada halaman pendaftaran :
\begin{verbatim}
...
Hasilnya  di Mozilla Firefox Akan mucul seperti ini :
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{figures/5daftar}
	\caption{Halaman Daftar}
\end{figure}
...
div[2]/ul/strong/li/ul/li[2]/a').clicl()
\end{verbatim} 

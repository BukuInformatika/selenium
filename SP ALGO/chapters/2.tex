...
Masukan kode dibawah ini yang berfungsi untuk mengimport modul selenium dan time.
\begin{verbatim}
from selenium import webdriver
...
Dibawah ini adalah tutorial untuk mencari Jenis kayu jati Dan memasukkannya ke dalam keranjang. Masukkan code berikut ini pada spyder:
\begin{verbatim}
...
Hasilnya akan seperti berikut ini pada web:
Hasil dari running code baris ke 1:
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{figures/jati}
	\caption{Mencari Kayu Jati}
\end{figure}

Kemudian masukkan code ini untuk memasukkan kayu jati ke dalam keranjang:
\begin{verbatim}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{figures/belikayu}
	\caption{Membeli Kayu Jati}
\end{figure}

\newpage
Klik button beli sekarang maka otomatis barang akan masuk ke dalam keranjang belanja:
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{figures/cart}
	\caption{Barang Masuk Ke dalam Keranjang}
\end{figure}

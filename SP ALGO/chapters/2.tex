...
\newpage
\subsection{Menemukan NIK KTP Pada Profil 2}
...
\newpage
\subsection {Menemukan NIK KTP pada Menu Profil 3}
Untuk menemukan NIK KTP pada profil, masukkan code berikut :
\begin{verbatim}
browser.find_element_by_xpath('/html/body/div/nav/div/div[2]
/ul/strong/li/a').click()
...
\newpage
\section {Mencari Jenis Kayu Jati dan Memasukkannya ke Keranjang Pembelian}
...
\subsection{Tutorial Mencari Jenis Kayu Jati}

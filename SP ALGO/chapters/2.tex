...
>>>>>>> 32b01042d5767ea8b46d511d75a96db6c3b5fd20
...
\newpage
\section{Tutorial Login Dan Masuk Ke Halaman Profil}
Kali ini kami akan membuat tutorial untuk masuk ke akun tokoperhutani.com dan melihat nik KTP pada menu profil.  
\subsection{Tutorial Login}
...
\newpage
\subsection{Membuka Halaman Profil}
...
\newpage
\section{Tutorial Login Dan Menemukan NIK KTP Pada Profile}
\subsection{Tutorial Login}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.25]{figures/L0}
	\caption{Login Berhasil}
\end{figure}

...
Berikut hasil debug dari code baris kedua:
\begin{figure}[h]
	\centering
...
Hasilnya akan tampak seperti berikut pada tampilan web :
Hasil running code baris ke 1 :
\begin{figure}[h]
	\centering
...
\end{verbatim}
Hasilnya akan sebagain berikut :
\begin{figure}[h]
	\centering
...
\newpage
Klik buttom beli sekarang maka otomatis barang akan masuk ke dalam keranjang belanja :
\begin{figure}[h]
	\centering

...
Lalu akan diarahkan ke Menu Konfirmasi Pemesanan yang terdapat pada Inbox akun.
...
\newpage
Jika kode tersebut berhasil dijalankan maka berikut hasil running dari kode di atas pada tombol ketersediaan akan berubah menjadi dipesan:
\begin{figure}[h]
	\centering
...
Kemudian untuk mengambil data dari tabel kayu yang dijual masukkan code sebagai berikut:
\begin{verbatim}
...
\end{verbatim}
Hasilnya data yang didapat akan di tampikan di spyder
...
Kemudian untuk mengambil data dari tabel pemesanan di user masukkan code sebagai berikut:
\begin{verbatim}
...
print(status_user)
\end{verbatim}
Hasilnya pada python console di spyder akan muncul status user.
...
Jika berhasil maka akan akan muncul keterangan "status aktif" pada python console di spyder:
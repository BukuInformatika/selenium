...
Setelah anda membuat tambahan codingan  seperti di atas untuk me-running program anda tekan run pada bar di atas. Saat kotak yang ditandai pada gambar di bawah berwarna merah, itu artinya proses running program tersebut masih berjalan. Setelah program di run akan otomatis membuka Mozila Firefox dan akan langsung membuka website tokoperhutani secara otomatis.

\begin{figure}[ht!]
	\centering
	\includegraphics[scale=0.3]{figures/1x}
	\caption{Navigator Menu Beranda}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Navigator Sertifikat Perhutani}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Navigator Pusat Bantuan}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Navigator Alamat Kantor}
\end{figure}
\\
